 ...
 * 
 * 1) 일반 함수 호출할 땐 this가 최상위 객체(gloal 또는 window)를 가리킨다.
...
// call, apply 차이
console.log(multiply.call(yuJin3, 3, 4, 5)); // call - 컴마 기준
console.log(multiply.apply(yuJin3, [3, 4, 5])); // apply - array 기준

/**
 * bind()
 */
const laterFunc = multiply.bind(yuJin3, 3, 4, 5); // 바로 함수가 실행되지 않고 나중에 반환
console.log(laterFunc);
console.log(laterFunc()); // 나중에 반환